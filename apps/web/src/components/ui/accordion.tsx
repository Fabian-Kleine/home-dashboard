...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <IconChevronDown data-slot="accordion-trigger-icon" className={cn(
          "pointer-events-none shrink-0",
          "transition-transform group-aria-expanded/accordion-trigger:rotate-0 not-[group-aria-expanded/accordion-trigger]:-rotate-90"
        )} />
      </AccordionPrimitive.Trigger>
